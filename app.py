...
blob_names = [
    ...
    "departamentos_poblacion.csv",        #df 3
    "VT_INSCRIPCIONES_EMPLEO_EMPRESAS.txt" #df 4
]
...
with tab1:
    ...
    show_inscriptions(dfs[4], dfs[0], dfs[2], dfs[3], file_dates[0],geojson_data)

with tab2:
    # Mostrar empresas
    show_companies(dfs[1])
